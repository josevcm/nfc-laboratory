...
#ifndef RADIO_HACKRFDEVICE_H
#define RADIO_HACKRFDEVICE_H
...
class HackrfDevice : public RadioDevice
{
   public:
   ...
   public:
      ...
      explicit HackrfDevice(int fd);

      explicit HackrfDevice(const std::string &name);
