...
static void save_err_str( const CHAR *str )
{
    ...
    pos += FormatMessage( FORMAT_MESSAGE_FROM_SYSTEM, NULL, dwMessageId, MAKELANGID( LANG_NEUTRAL, SUBLANG_DEFAULT ), error_buffer+pos, sizeof(error_buffer)-pos, NULL );
...
void *dlopen( const char *file, int mode )
{
    ...
    else
    {
        ...
        hModule = LoadLibraryEx(lpFileName, NULL, LOAD_WITH_ALTERED_SEARCH_PATH );
...
__declspec(noinline) void *dlsym( void *handle, const char *name )
{
    FARPROC symbol;
    HMODULE hCaller;
    HMODULE hModule;
